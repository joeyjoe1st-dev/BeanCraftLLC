...
@EventBusSubscriber
public class FalseBeanBiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<FalseBeanBiomeFruitDecorator> CODEC = MapCodec.unit(FalseBeanBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("beancraft:false_bean_biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public FalseBeanBiomeFruitDecorator() {
		super(0.2f);
	}
