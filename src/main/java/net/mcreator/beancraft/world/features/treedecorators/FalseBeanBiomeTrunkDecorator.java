...
@EventBusSubscriber
public class FalseBeanBiomeTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<FalseBeanBiomeTrunkDecorator> CODEC = MapCodec.unit(FalseBeanBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("beancraft:false_bean_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
