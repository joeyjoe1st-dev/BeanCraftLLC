package net.mcreator.beancraft.world.features.treedecorators;
...
@EventBusSubscriber
public class FalseBeanBiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<FalseBeanBiomeLeaveDecorator> CODEC = MapCodec.unit(FalseBeanBiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("beancraft:false_bean_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public FalseBeanBiomeLeaveDecorator() {
		super(0.25f);
	}
