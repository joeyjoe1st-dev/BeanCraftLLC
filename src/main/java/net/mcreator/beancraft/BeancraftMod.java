...
import net.mcreator.beancraft.init.*;
...
@Mod("beancraft")
public class BeancraftMod {
	public static final Logger LOGGER = LogManager.getLogger(BeancraftMod.class);
	public static final String MODID = "beancraft";

	public BeancraftMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		BeancraftModBlocks.REGISTRY.register(modEventBus);
		BeancraftModBlockEntities.REGISTRY.register(modEventBus);
